...
namespace DAL
{
    ...
    partial void OnDepartmentIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_D", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int D
		{
			get
			{
    ...
    partial void OnIDChanging(int value);
    partial void OnIDChanged();
    partial void OnEmplieeIDChanging(int value);
    partial void OnEmplieeIDChanged();
    ...
    partial void OnMonthIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EmplieeID", DbType="Int NOT NULL")]
		public int EmplieeID
		{
			get
			{
				return this._EmplieeID;
			}
			set
			{
				if ((this._EmplieeID != value))
				{
					this.OnEmplieeIDChanging(value);
					this.SendPropertyChanging();
					this._EmplieeID = value;
					this.SendPropertyChanged("EmplieeID");
					this.OnEmplieeIDChanged();
				}
			}
		}
